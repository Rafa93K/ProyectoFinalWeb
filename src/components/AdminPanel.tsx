    ...
    <div className="flex-1 bg-stone-100 p-6 md:p-10 font-sans">
      ...
      {modalAbierto && (
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center p-4 z-50">
          <div className="bg-white rounded-3xl w-full max-w-lg shadow-2xl animate-modalEnter origin-center max-h-[90vh] flex flex-col">
            ...
            <div className="p-6 overflow-y-auto">
              <form onSubmit={guardarCambios} className="space-y-4">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    ...
                    <input 
                      type="text" 
                      required
                      className="w-full px-3 py-2 rounded-xl border border-stone-200 focus:ring-2 focus:ring-stone-800 outline-none transition-all text-sm"
                ...
                <div>
                  ...
                  <textarea 
                    className="w-full px-3 py-2 rounded-xl border border-stone-200 focus:ring-2 focus:ring-stone-800 outline-none transition-all h-20 resize-none text-sm"
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <select 
                      ...
                      className={`w-full px-3 py-2 rounded-xl border border-stone-200 focus:ring-2 focus:ring-stone-800 outline-none transition-all text-sm ${datosFormulario.tipo === 'especial' ? 'bg-stone-50 text-stone-400 cursor-not-allowed' : ''}`}
                  ...
                  <div className="flex items-center gap-3">
                    <div className="flex-1">
                      ...
                      <label 
                        ...
                        className="flex items-center justify-center w-full h-20 border-2 border-dashed border-stone-200 rounded-xl hover:bg-stone-50 cursor-pointer transition-all gap-3"
                      >
                ...
                <div className="flex gap-3 pt-2">
                  <button 
                    ...
                    className="flex-1 px-4 py-3 rounded-xl font-bold bg-stone-100 text-stone-600 hover:bg-stone-200 transition-all text-sm"
                  >
                    Cerrar
                  </button>
                  <button 
